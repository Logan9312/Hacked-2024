...
const App = () => {
  ...
  const dashboardItems = [
    { title: "Payments Due", icon: "cash-outline", color: "bg-yellow-400" },
    { title: "Tasks", icon: "checkmark-circle-outline", color: "bg-blue-400" },
    { title: "Grocery List", icon: "cart-outline", color: "bg-green-400" },
    { title: "Messages", icon: "chatbubbles-outline", color: "bg-purple-400" },
  ];
...
<TouchableOpacity key={index} style={{ flex: 1 }} className={`${item.color} rounded-lg p-4 flex items-center justify-between`}>
